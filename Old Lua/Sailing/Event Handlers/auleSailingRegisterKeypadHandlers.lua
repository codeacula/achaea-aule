function auleSailingRegisterKeypadHandlers()
  ...
  aule.keypad.registerHandler("5", function() return send("spyglass look") end)
  ...
  aule.keypad.registerHandler("/", function() return send("ship dock "..aule.sailing.ship.heading.." confirm") end)
